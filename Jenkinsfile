...
// for display purposes
      ...
      git 'https://github.com/paragdodewar/hello-world-servlet.git'
...
post {
        success {
            mail to:"paragdodewar845@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"paragdodewar845@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
